...
def prepare_vae(args, state_dict=None):
    ...
    datasets = load_data(
        ...
        train_vae=True,
        cell_type_line = args["cell_type_line"]
    )
...
def parse_arguments():
    ...
    parser.add_argument("--state_dict", type=str, default="/work/home/cryoem666/xyf/temp/pycharm/scimilarity/file")  # if pretrain
    ...
    parser.add_argument("--cell_type_line", type=str, default='cell_line')  # for muris use 'cell_ontology_class', for sapiens use 'celltype'
